...
#include "../../../src/auth/loginwidget.h"
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showRegisterRequested(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginWidget::*)(const QString & , const QString & )>(_a, &LoginWidget::loginRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LoginWidget::*)()>(_a, &LoginWidget::showRegisterRequested, 1))
            return;
    }
}
...
// SIGNAL 1
void LoginWidget::showRegisterRequested()
{
