...
#include "../../../src/auth/registerwidget.h"
...
void RegisterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showLoginRequested(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (RegisterWidget::*)(const QString & , const QString & )>(_a, &RegisterWidget::registerRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (RegisterWidget::*)()>(_a, &RegisterWidget::showLoginRequested, 1))
            return;
    }
}
...
// SIGNAL 1
void RegisterWidget::showLoginRequested()
{
